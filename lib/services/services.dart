...
/// Enable when combine Delivery to Vendor app
import '../frameworks/delivery/services/delivery_mixin.dart';
import '../frameworks/delivery/index.dart' show DeliveryMixin;

/// Enable when combine FluxStore Manager to Vendor app
...
class Services
    with
        ...
        ServiceVendorMixin,
        WordPressMixin,
        // Enable when combine Delivery or FluxStore Admin to Vendor app
        VendorAdminMixin,
        DeliveryMixin,
        WalletServiceMixin,
