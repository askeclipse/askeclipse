...
import '../../../frameworks/vendor/featured_vendors_layout.dart' as vendor;
import '../../../api/url.dart';
      ...
      child: GestureDetector(
        onTap: () {
          http.post(
              ...
              body: jsonEncode({
                "fields":{  "TITLE": "Category ${config.category}",
                  "SOURCE_DESCRIPTION":"AskEclipse Category",
                  "STATUS_ID": "NEW",
                  "OPENED": "Y",
                  "ASSIGNED_BY_ID": 1,
                  //"EMAIL": [ { "VALUE": loggedInUser?.email, "VALUE_TYPE": "WORK" } ],
                  //"PHONE": [ { "VALUE": loggedInUser?.phoneNumber, "VALUE_TYPE": "WORK" } ]
                }
              })
          );
